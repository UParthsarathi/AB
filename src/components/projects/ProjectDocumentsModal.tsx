...
export function ProjectDocumentsModal({ project, isOpen, onClose, onUpdateProject, onDeleteDoc }: ProjectDocumentsModalProps) {
  ...
  const submitDoc = (e: React.FormEvent) => {
    ...
    const newDoc = {
      ...
      title: dTitle,
      type: docUploadMode === 'link' ? 'External Link' : 'Uploaded File',
      url: dUrl || '#',
