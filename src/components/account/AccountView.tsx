      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="md:col-span-1 space-y-4 sm:space-y-6">
          <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-[#0f0f11] shadow-sm flex flex-col items-center text-center">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">parthu3915</h3>
            <p className="text-xs sm:text-sm text-gray-500 mb-4 sm:mb-6">parthu3915@gmail.com</p>
          ...
          <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-[#0f0f11] shadow-sm">
            <button className="w-full flex items-center gap-3 text-red-600 dark:text-red-400 font-medium py-2 hover:bg-red-50 dark:hover:bg-red-900/10 rounded-lg px-3 transition-colors">
